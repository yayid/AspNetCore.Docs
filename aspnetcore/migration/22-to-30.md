...
Authorization can also be configured for specific classes of endpoints. Here's an example of converting an MVC application that configured a global `AuthorizeFilter` with a specific policy to use `RequireAuthorization`
